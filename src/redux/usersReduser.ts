...
type ActionsTypes = FollowSuccessType | UnFollowSuccessType | SetUsersType | SetCurrentPageType | SetTotalUsersCountType | ToggleIsLoadingType | ToggleFollowingProgressType
